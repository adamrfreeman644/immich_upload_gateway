...
const slug={json.dumps(slug)},tok={json.dumps(p.get('upload_token',''))};const f=document.getElementById('f'),b=document.getElementById('b'),s=document.getElementById('s'),pr=document.getElementById('pr'),fi=document.getElementById('fi');
